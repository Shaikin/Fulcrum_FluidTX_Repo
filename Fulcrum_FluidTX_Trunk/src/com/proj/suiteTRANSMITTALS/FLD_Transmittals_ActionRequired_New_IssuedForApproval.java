...
public class FLD_Transmittals_ActionRequired_New_IssuedForApproval extends TestSuiteBase{

	private String local_testcaseName=FLD_Transmittals_ActionRequired_New_IssuedForApproval.class.getSimpleName();	
	String input="";
	...
	private String local_refID="FLU-TRAN-03";
	...
	public static void TestFLD_Transmittals_ActionRequired_New_IssuedForApproval(Hashtable<String,String>data
			) throws Throwable{
		...
		try{
			...
			//************************************** LEVEL 2 *****************************************************************************		
			driver_TRANS=Workflows.Level2_Validate_OR_Submit_OR_ApproveOrReject_OR_Forward_Transmittal(siteName,Constants_Workflow.page_actionRequired,driver_TRANS,refID,testcaseName, workflow_l2, condition, workflow_end, url, browserName, username2, password2, transmittalData, data);
			//************************************** LEVEL 3 *****************************************************************************
			driver_TRANS=Workflows.Level3_ValidateForwarded_And_ApproveOrReject_Transmittal(siteName,Constants_Workflow.page_actionRequired,driver_TRANS,refID,testcaseName, workflow_l3, condition, workflow_end, url, browserName, username1, password1, transmittalData, data);
