...
public class FLD_Transmittals_New_IssuedForApproval extends TestSuiteBase{

	private String local_testcaseName=FLD_Transmittals_New_IssuedForApproval.class.getSimpleName();	
	String input="";
	...
	public static void TestFLD_Transmittals_New_IssuedForApproval(Hashtable<String,String>data
			) throws Throwable{
		...
		try{
			...
			//************************************** LEVEL 2 *****************************************************************************		
			driver_TRANS=Workflows.Level2_Validate_OR_Submit_OR_ApproveOrReject_OR_Forward_Transmittal(siteName,driver_TRANS, workflow_l2, condition, workflow_end, url, browserName, username2, password2, transmittalData, data);
			//************************************** LEVEL 3 *****************************************************************************
			driver_TRANS=Workflows.Level3_ValidateForwarded_And_ApproveOrReject_Transmittal(siteName,driver_TRANS, workflow_l3, condition, workflow_end, url, browserName, username1, password1, transmittalData, data);
