...
public class FLD_Transmittals_ActionRequired_CaC_IssuedForApproval extends TestSuiteBase{

	private String local_testcaseName=FLD_Transmittals_ActionRequired_CaC_IssuedForApproval.class.getSimpleName();	
	String input="";
	...
	public static void TestFLD_Transmittals_ActionRequired_CaC_IssuedForApproval(Hashtable<String,String>data
			) throws Throwable{
