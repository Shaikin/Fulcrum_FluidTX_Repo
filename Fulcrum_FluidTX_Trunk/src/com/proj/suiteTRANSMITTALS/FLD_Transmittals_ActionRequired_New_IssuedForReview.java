...
public class FLD_Transmittals_ActionRequired_New_IssuedForReview extends TestSuiteBase{

	private String local_testcaseName=FLD_Transmittals_ActionRequired_New_IssuedForReview.class.getSimpleName();	
	String input="";
	...
	public static void TestFLD_Transmittals_ActionRequired_New_IssuedForReview(Hashtable<String,String>data
			) throws Throwable{
