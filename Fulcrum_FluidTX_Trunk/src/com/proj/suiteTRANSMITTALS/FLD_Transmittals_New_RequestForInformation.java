...
public class FLD_Transmittals_New_RequestForInformation extends TestSuiteBase{

	private String local_testcaseName=FLD_Transmittals_New_RequestForInformation.class.getSimpleName();	
	String input="";
	...
	public static void TestFLD_Transmittals_New_RequestForInformation(Hashtable<String,String>data
			) throws Throwable{
