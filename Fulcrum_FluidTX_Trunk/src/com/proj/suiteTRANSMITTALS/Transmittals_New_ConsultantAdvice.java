...
public class Transmittals_New_ConsultantAdvice extends TestSuiteBase{
	...
	private String local_testcaseName=Transmittals_New_ConsultantAdvice.class.getSimpleName();	
	String input="";
	...
	private String local_refID="TRAN-02";
	...
	public static void TestTransmittals_New_ConsultantAdvice(Hashtable<String,String>data
			) throws Throwable{
