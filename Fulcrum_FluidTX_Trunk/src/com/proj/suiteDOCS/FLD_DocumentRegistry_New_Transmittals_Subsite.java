...
public class FLD_DocumentRegistry_New_Transmittals_Subsite extends TestSuiteBase{
	...
	private String local_testcaseName=FLD_DocumentRegistry_New_Transmittals_Subsite.class.getSimpleName();
	private String local_refID="LATFLD-14";
	String input="";
	...
	public static void TestFLD_DocumentRegistry_New_Transmittals_Subsite(Hashtable<String,String>data
		...
		//************************************** LEVEL 2 *****************************************************************************
		String subsite=ApplicationMethods.getSubsite(url, data.get("Subsite"));
		String username=CONFIG.getProperty("userUserName3");
		String password=CONFIG.getProperty("userpassword3");
